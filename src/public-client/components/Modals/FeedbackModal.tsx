...
const FeedbackModal = ({ rating, message, onClose }: FeedbackModalProps) => {
  ...
  return (
    <div className="fixed inset-0 bg-black/60 backdrop-blur-2xl z-[100] flex items-center justify-center p-4" onClick={onClose}>
      {/* Main Modal Card */}
      <div className="bg-white rounded-3xl max-w-md w-full overflow-hidden shadow-2xl border border-white/60 relative my-8">
        
        {/* Decorative Gradient Orb - keep it subtle */}
